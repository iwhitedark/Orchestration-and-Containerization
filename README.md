# Итоговый проект «Разработка и развертывание ИИ-приложения в Kubernetes» по дисциплине "Оркестрация и контейнеризация". 1-й семестр 2-го курса МИФИ ИИКС РПО (2025-2026 уч. г).
